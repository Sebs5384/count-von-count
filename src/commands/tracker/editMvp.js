...
const command = new SlashCommandBuilder()
    ...
    .addStringOption((option) => option
        .setName('name')
        .setDescription('Input the current name of the MVP to be edited')
        .setMaxLength(30)
        .setRequired(true)
    )
    .addStringOption((option) => option
        .setName('new-name')
        .setDescription('Input the new name of the MVP')
        .setMaxLength(30)
        .setRequired(false)
    )
    .addIntegerOption((option) => option
        .setName('new-downtime')
        .setDescription('Input the new downtime of the MVP in minutes')
        .setMinValue(1)
        .setMaxValue(1440)
        .setRequired(false)
    )
    .addIntegerOption((option) => option
        ...
        .setDescription('Input the new spawn window of the MVP in minutes')
        .setMinValue(0)
        .setMaxValue(1440)
        .setRequired(false)
    )
    .addStringOption((option) => option
        .setName('new-map')
        .setDescription('Input the new map of the MVP')
        .setRequired(false)
    )
    .addStringOption((option) => option
        .setName('new-emoji')
        .setDescription('Input the new emoji of the MVP')
        .setRequired(false)
    );
